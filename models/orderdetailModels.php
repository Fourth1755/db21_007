<?php
    class Orderdetail{
        ...
        public static function update($Orderdetail_ID,$Order_ID,$Colordetail_ID,$Orderdetail_QuantityColor,$Orderdetail_Quantity){
            require("connection_connect.php");
            $sql="UPDATE `QuotationDetail` SET `Quotation_ID` = '$Order_ID', `ColorDetail_ID` = '$Colordetail_ID', `QuotationDetail_QuantityColor` = '$Orderdetail_QuantityColor', `QuotationDetail_Quantity` = '$Orderdetail_Quantity' WHERE `QuotationDetail`.`QuotationDetail_ID` = '$Orderdetail_ID';";
            $result = $conn->query($sql);
            require("connection_close.php");
